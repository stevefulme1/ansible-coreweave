"""Unit tests for stevefulme1.coreweave.coreweave_network_policy module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.coreweave.plugins.modules.coreweave_network_policy"
...
class TestCreateNetworkPolicy:
    """Tests for creating a network_policy."""
    ...
    def test_create_with_all_params(self, mock_api_client):
        ...
        params = {
            "policy_name": "full-network_policy",
            "description": "Full test",
            "tags": {"env": "test"},
        }
        mock_api_client.create("network_policy", params)
        mock_api_client.create.assert_called_once_with("network_policy", params)
    ...
    def test_create_api_error(self):
        ...
        with pytest.raises(Exception, match="409 Conflict"):
            client.create("network_policy", {"policy_name": "dup"})

    def test_create_check_mode_no_api_call(self, mock_api_client):
        """Verify check_mode skips actual API call."""
        check_mode = True
        if check_mode:
            result = {"changed": True, "network_policy": {}}
        else:
            result = mock_api_client.create("network_policy", {})
        assert result["changed"] is True
        mock_api_client.create.assert_not_called()


class TestUpdateNetworkPolicy:
    """Tests for updating a network_policy."""
    ...
    def test_update_existing_resource(self, mock_api_client, existing_resource):
        ...
        result = mock_api_client.update("network_policy", "res-123", {"policy_name": "updated"})
        assert result["policy_name"] == "test-network_policy-updated"
    ...
    def test_update_nonexistent_raises(self, mock_api_client):
        ...
        with pytest.raises(Exception, match="404 Not Found"):
            mock_api_client.update("network_policy", "bad-id", {})


class TestDeleteNetworkPolicy:
    """Tests for deleting a network_policy."""

    def test_delete_existing(self, mock_api_client, existing_resource):
        """Verify delete calls API with correct ID."""
        mock_api_client.get.return_value = existing_resource
        mock_api_client.delete("network_policy", "res-123")
        mock_api_client.delete.assert_called_once_with("network_policy", "res-123")

    def test_delete_nonexistent_is_noop(self, mock_api_client):
        """Verify deleting absent resource reports no change."""
        mock_api_client.get.return_value = None
        result = mock_api_client.get("network_policy", "missing-id")
    ...
    def test_delete_api_error(self):
        ...
        with pytest.raises(Exception, match="403 Forbidden"):
            client.delete("network_policy", "res-123")


class TestGetNetworkPolicy:
    """Tests for getting a network_policy."""
    ...
    def test_get_nonexistent(self, mock_api_client):
        ...
        mock_api_client.get.return_value = None
        result = mock_api_client.get("network_policy", "nonexistent")
        assert result is None
    ...
    def test_get_api_timeout(self):
        ...
        with pytest.raises(TimeoutError):
            client.get("network_policy", "res-123")


class TestListNetworkPolicy:
    """Tests for listing network_policy resources."""
...
class TestIdempotencyNetworkPolicy:
    """Tests for idempotent behavior of network_policy."""
    ...
    def test_create_existing_is_idempotent(self, mock_api_client, existing_resource):
        ...
        mock_api_client.get.return_value = existing_resource
        current = mock_api_client.get("network_policy", "res-123")
    ...
    def test_delete_absent_is_idempotent(self, mock_api_client):
        ...
        mock_api_client.get.return_value = None
        exists = mock_api_client.get("network_policy", "missing") is not None
        assert exists is False


class TestErrorHandlingNetworkPolicy:
    """Tests for error handling in network_policy."""
