"""Unit tests for stevefulme1.coreweave.coreweave_vpc module."""
...
@pytest.fixture
def mock_api_client():
    """Mock API client for coreweave_vpc."""
    client = MagicMock()
    client.get.return_value = None
    client.create.return_value = {"vpc_id": "res-123", "name": "test-vpc"}
    client.update.return_value = {"vpc_id": "res-123", "name": "test-vpc-updated"}
...
class TestCreateVpc:
    ...
    def test_create_returns_resource(self, mock_api_client):
        ...
        result = mock_api_client.create("vpc", {"name": "test-vpc"})
...
class TestUpdateVpc:
    ...
    def test_update_existing_resource(self, mock_api_client, existing_resource):
        ...
        result = mock_api_client.update("vpc", "res-123", {"name": "updated"})
        assert result["name"] == "test-vpc-updated"
...
class TestListVpc:
    ...
    def test_list_with_filter(self, mock_api_client):
        ...
        mock_api_client.list.return_value = [{"vpc_id": "1", "name": "match"}]
        result = mock_api_client.list("vpc", filters={"name": "match"})
        assert len(result) == 1
