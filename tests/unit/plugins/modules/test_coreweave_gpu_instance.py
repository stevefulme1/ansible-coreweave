"""Unit tests for stevefulme1.coreweave.coreweave_gpu_instance module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.coreweave.plugins.modules.coreweave_gpu_instance"
...
def mock_api_client():
    ...
    client.create.return_value = {"id": "res-123", "name": "test-gpu_instance"}
...
def existing_resource():
    """Return a dict representing an existing gpu_instance."""
    return {
        "instance_id": "res-123",
        "name": "test-gpu_instance",
        "state": "active",
    }


class TestCreateGpuInstance:
    """Tests for creating a gpu_instance."""
    ...
    def test_create_with_all_params(self, mock_api_client):
        ...
        params = {
            "name": "full-gpu_instance",
            "description": "Full test",
            "tags": {"env": "test"},
        }
        mock_api_client.create("gpu_instance", params)
        mock_api_client.create.assert_called_once_with("gpu_instance", params)
    ...
    def test_create_api_error(self):
        ...
        with pytest.raises(Exception, match="409 Conflict"):
            client.create("gpu_instance", {"name": "dup"})

    def test_create_check_mode_no_api_call(self, mock_api_client):
        """Verify check_mode skips actual API call."""
        check_mode = True
        if check_mode:
            result = {"changed": True, "gpu_instance": {}}
        else:
            result = mock_api_client.create("gpu_instance", {})
        assert result["changed"] is True
        mock_api_client.create.assert_not_called()


class TestUpdateGpuInstance:
    """Tests for updating a gpu_instance."""
    ...
    def test_update_existing_resource(self, mock_api_client, existing_resource):
        ...
        result = mock_api_client.update("gpu_instance", "res-123", {"name": "updated"})
        assert result["name"] == "test-gpu_instance-updated"
    ...
    def test_update_nonexistent_raises(self, mock_api_client):
        ...
        with pytest.raises(Exception, match="404 Not Found"):
            mock_api_client.update("gpu_instance", "bad-id", {})


class TestDeleteGpuInstance:
    """Tests for deleting a gpu_instance."""

    def test_delete_existing(self, mock_api_client, existing_resource):
        """Verify delete calls API with correct ID."""
        mock_api_client.get.return_value = existing_resource
        mock_api_client.delete("gpu_instance", "res-123")
        mock_api_client.delete.assert_called_once_with("gpu_instance", "res-123")

    def test_delete_nonexistent_is_noop(self, mock_api_client):
        """Verify deleting absent resource reports no change."""
        mock_api_client.get.return_value = None
        result = mock_api_client.get("gpu_instance", "missing-id")
    ...
    def test_delete_api_error(self):
        ...
        with pytest.raises(Exception, match="403 Forbidden"):
            client.delete("gpu_instance", "res-123")


class TestGetGpuInstance:
    """Tests for getting a gpu_instance."""
    ...
    def test_get_nonexistent(self, mock_api_client):
        ...
        mock_api_client.get.return_value = None
        result = mock_api_client.get("gpu_instance", "nonexistent")
        assert result is None
    ...
    def test_get_api_timeout(self):
        ...
        with pytest.raises(TimeoutError):
            client.get("gpu_instance", "res-123")


class TestListGpuInstance:
    """Tests for listing gpu_instance resources."""
    ...
    def test_list_returns_all(self, mock_api_client):
        ...
        result = mock_api_client.list("gpu_instance")
        assert len(result) == 2
    ...
    def test_list_with_filter(self, mock_api_client):
        ...
        result = mock_api_client.list("gpu_instance", filters={"name": "match"})
        assert len(result) == 1


class TestIdempotencyGpuInstance:
    """Tests for idempotent behavior of gpu_instance."""
    ...
    def test_create_existing_is_idempotent(self, mock_api_client, existing_resource):
        ...
        mock_api_client.get.return_value = existing_resource
        current = mock_api_client.get("gpu_instance", "res-123")
    ...
    def test_delete_absent_is_idempotent(self, mock_api_client):
        ...
        mock_api_client.get.return_value = None
        exists = mock_api_client.get("gpu_instance", "missing") is not None
        assert exists is False


class TestErrorHandlingGpuInstance:
    """Tests for error handling in gpu_instance."""
