...
"""Ansible module: coreweave_vpc_info."""
...
options:
    vpc_name:
        description: ID of a specific vpc to retrieve.
        type: str
    name:
...
RETURN = r"""
vpcs:
    description: List of vpc details.
    returned: always
    type: list
    elements: dict
"""
...
def main():
    ...
    if resource_id:
        result = client.get("vpc", resource_id)
        resources = [result] if result else []
    else:
        resources = client.list("vpc", module.params)

    module.exit_json(changed=False, vpcs=resources)
