...
DOCUMENTATION = r"""
---
module: coreweave_floating_ip
short_description: Manage CoreWeave floating IPs
description:
    - Manage CoreWeave floating IPs.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: Create
  stevefulme1.coreweave.coreweave_floating_ip:
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("ip_id",))],
    )
