...
"""coreweave_load_balancer module."""
...
DOCUMENTATION = r"""
---
module: coreweave_load_balancer
short_description: Manage CoreWeave load balancers
description:
    - Manage CoreWeave load balancers.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: Create
  stevefulme1.coreweave.coreweave_load_balancer:
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("lb_name",))],
    )
