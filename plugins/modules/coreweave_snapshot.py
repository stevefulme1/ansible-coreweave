...
DOCUMENTATION = r"""
---
module: coreweave_snapshot
short_description: Manage CoreWeave volume snapshots
description:
    - Manage CoreWeave volume snapshots.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: Create
  stevefulme1.coreweave.coreweave_snapshot:
